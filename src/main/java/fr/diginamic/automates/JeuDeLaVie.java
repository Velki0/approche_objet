...
import fr.diginamic.automates.patterns.LecturePattern;
...
public class JeuDeLaVie {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        LecturePattern.LancerPattern();

        // Lecture Pattern Aléatoire :
//        final int lignesTotales = 5;
//        final int colonnesTotales = 5;
